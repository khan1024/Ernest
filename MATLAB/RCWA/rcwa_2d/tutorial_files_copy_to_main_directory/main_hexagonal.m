...
%---------------------------------------------------
N_X=2; % N_X=20 takes approx. 8 GB of memory
N_Y=N_X;
use_fftw=2;
%---------------------------------------------------
Lambda_x=0.5; %  [um] only grating 1 and 2
Lambda_y=Lambda_x*sqrt(3); %  [um] only for grating 1 and 2
n_1=1.0; % superstrate
n_3=sqrt(2.56); % substrate
mu=1;
%---------------------------------------------------
...
switch grating
    case 0
        ...
        %open_grating_file='coaxial_apertures_array.m';
        %open_grating_file='rectangular_grating.m';
        %open_grating_file='test_antos_grating.m';
        open_grating_file='hexagonal_grating.m';
...
diffraction_efficiency_order=[-1,-3]; 
save_m=0; % 1 --- yes, 2 ---no
save_m_as='test';
...
switch measurement
    ...
    case 1
        minimum_N_X_N_Y=2; %
        maximum_N_X_N_Y=16; % max. 20 (it takes 8 GB)
        step=1;
    case 2 
