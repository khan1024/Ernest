...
use_fftw=2;
%---------------------------------------------------
Lambda_x=2; %  [um] only for grating 1 and 2
...
zeta0=30; % nonrectangular coordinate system, zeta0=0 ->rectangular coordinate system
...
switch grating
    case 0
        setup_dispersion;
        open_grating_file='binary_slanted.m';
    ...
    case 1 % eliptic cylinder, rectangular grating
        ...
        n_cylinder=1.5;
        thickness=1; % [um]
        a_ellipse=0.5; % semi-axis [um]
        b_ellipse=0.5; % semi-axis [um]
...
switch measurement
    ...
    case 1
        minimum_N_X_N_Y=1; %
        maximum_N_X_N_Y=10; % max. 20 (it takes 8 GB)
        step=1;
    case 2 
