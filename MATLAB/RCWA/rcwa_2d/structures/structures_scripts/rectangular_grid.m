...
function [p_x,p_y,mesh_n_mat]=rectangular_grid(Lambda_x,Lambda_y,resolution_dx,r_cylinder,n_cylinder,n_layer,show_grating_mesh)
...
for i=1:1:length(p_y)-1
    for j=1:1:length(p_x)-1
        ...
        for k=1:1:number_of_objects
            ...
            distance_origin_pixel=sqrt((pixel_center(i,j,1)-object(1,1,k))^2+(pixel_center(i,j,2)-object(1,2,k))^2);
