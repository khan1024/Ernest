...
switch plottype
    case 1 
        ...
        title ({['Transmitted Diffraction Efficiency for 1D ' gratingcaselabel(gratingcase+1,:) ' Grating Period Sweep for TM Light with '],[ num2str(thickness_total(1,thick)) ' um thickness ' num2str(dutycycle(1,d)) ' duty cycle for ' num2str(lambda(1,l)) ' um light from n=' num2str(n1) ' to n=' num2str(n3) ', AOI=' num2str(theta0(1,t))]},'FontSize',14)
        saveas(h1,['.\figures\Transmitted Diffraction Efficiency for 1D ' gratingcaselabel(gratingcase+1,:) ' Grating for TM Light with ' num2str(thickness_total(1,thick)) ' um thickness ' num2str(dutycycle(1,d)) ' duty cycle for ' num2str(lambda(1,l)) ' um light from n=' num2str(n1) ' to n=' num2str(n3)  ', AOI=' num2str(theta0(1,t)) '.png'])
        ...
        title ({['Reflected Diffraction Efficiency for 1D ' gratingcaselabel(gratingcase+1,:) ' Grating Period Sweep for TM Light with '],[ num2str(thickness_total(1,thick)) ' um thickness ' num2str(dutycycle(1,d)) ' duty cycle for ' num2str(lambda(1,l)) ' um light from n=' num2str(n1) ' to n=' num2str(n3) ', AOI=' num2str(theta0(1,t))]},'FontSize',14)
        saveas(h2,['.\figures\Reflected Diffraction Efficiency for 1D ' gratingcaselabel(gratingcase+1,:) ' Grating Period Sweep for TM Light with ' num2str(thickness_total(1,thick)) ' um thickness ' num2str(dutycycle(1,d)) ' duty cycle for ' num2str(lambda(1,l)) ' um light from n=' num2str(n1) ' to n=' num2str(n3)  ', AOI=' num2str(theta0(1,t)) '.png'])
    ...
    case 2
        ...
        zlabel ('Transmision Efficiency','FontSize',16)
        title ({['Transmitted Diffraction Efficiency for 1D ' gratingcaselabel(gratingcase+1,:) ' Grating Thickness Sweep for TM Light with '],[ num2str(Lambda(1,L)) ' um period ' num2str(dutycycle(1,d)) ' duty cycle for ' num2str(lambda(1,l)) ' um light from n=' num2str(n1) ' to n=' num2str(n3) ', AOI=' num2str(theta0(1,t))]},'FontSize',14)
        saveas(h3,['.\figures\Transmitted Diffraction Efficiency for 1D ' gratingcaselabel(gratingcase+1,:) ' Grating Thickness Sweep for TM Light with ' num2str(Lambda(1,L)) ' um period ' num2str(dutycycle(1,d)) ' duty cycle for ' num2str(lambda(1,l)) ' um light from n=' num2str(n1) ' to n=' num2str(n3)  ', AOI=' num2str(theta0(1,t)) '.png'])
        ...
        ylabel ('Grating Thickness (micrometers)','FontSize',16)
        zlabel ('Reflection Efficiency','FontSize',16)
        title ({['Reflected Diffraction Efficiency for 1D ' gratingcaselabel(gratingcase+1,:) ' Grating Thickness Sweep for TM Light with '],[ num2str(Lambda(1,L)) ' um period ' num2str(dutycycle(1,d)) ' duty cycle for ' num2str(lambda(1,l)) ' um light from n=' num2str(n1) ' to n=' num2str(n3) ', AOI=' num2str(theta0(1,t))]},'FontSize',14)
        saveas(h4,['.\figures\Reflected Diffraction Efficiency for 1D ' gratingcaselabel(gratingcase+1,:) ' Grating Thickness Sweep for TM Light with ' num2str(Lambda(1,L)) ' um period ' num2str(dutycycle(1,d)) ' duty cycle for ' num2str(lambda(1,l)) ' um light from n=' num2str(n1) ' to n=' num2str(n3)  ', AOI=' num2str(theta0(1,t)) '.png'])
    ...
    case 3
        ...
        zlabel ('Transmision Efficiency','FontSize',16)
        title ({['Transmitted Diffraction Efficiency for 1D ' gratingcaselabel(gratingcase+1,:) ' Grating Wavelength Sweep for TM Light with '],[ num2str(thickness_total(1,thick)) ' um thickness, ' num2str(dutycycle(1,d)) ' duty cycle, ' num2str(Lambda(1,L)) ' um period from n=' num2str(n1) ' to n=' num2str(n3) ', AOI=' num2str(theta0(1,t))]},'FontSize',14)
        saveas(h5,['.\figures\Transmitted Diffraction Efficiency for 1D ' gratingcaselabel(gratingcase+1,:) ' Grating Wavelength Sweep for TM Light with ' num2str(thickness_total(1,thick)) ' um thickness, ' num2str(dutycycle(1,d)) ' duty cycle, ' num2str(Lambda(1,L)) ' um period from n=' num2str(n1) ' to n=' num2str(n3)  ', AOI=' num2str(theta0(1,t)) '.png'])
        ...
        ylabel ('Wavelength (micrometers)','FontSize',16)
        zlabel ('Reflection Efficiency','FontSize',16)
        title ({['Reflected Diffraction Efficiency for 1D ' gratingcaselabel(gratingcase+1,:) ' Grating Wavelength Sweep for TM Light with '],[ num2str(thickness_total(1,thick)) ' um thickness, ' num2str(dutycycle(1,d)) ' duty cycle, ' num2str(Lambda(1,L)) ' um period from n=' num2str(n1) ' to n=' num2str(n3) ', AOI=' num2str(theta0(1,t))]},'FontSize',14)
        saveas(h6,['.\figures\Reflected Diffraction Efficiency for 1D ' gratingcaselabel(gratingcase+1,:) ' Grating Wavelength Sweep for TM Light with ' num2str(thickness_total(1,thick)) ' um thickness, ' num2str(dutycycle(1,d)) ' duty cycle, ' num2str(Lambda(1,L)) ' um period from n=' num2str(n1) ' to n=' num2str(n3)  ', AOI=' num2str(theta0(1,t)) '.png'])
    ...
    case 4
        ...
        zlabel ('Transmision Efficiency','FontSize',16)
        title ({['Transmitted Diffraction Efficiency for 1D ' gratingcaselabel(gratingcase+1,:) ' Grating Duty Cycle Sweep for TM Light with '],[ num2str(thickness_total(1,thick)) ' um thickness, ' num2str(Lambda(1,L)) ' um period for ' num2str(lambda(1,l)) ' um light from n=' num2str(n1) ' to n=' num2str(n3) ', AOI=' num2str(theta0(1,t))]},'FontSize',14)
        saveas(h7,['.\figures\Transmitted Diffraction Efficiency for 1D ' gratingcaselabel(gratingcase+1,:) ' Grating Duty Cycle Sweep for TM Light with ' num2str(thickness_total(1,thick)) ' um thickness, ' num2str(Lambda(1,L)) ' um period for ' num2str(lambda(1,l)) ' um light from n=' num2str(n1) ' to n=' num2str(n3)  ', AOI=' num2str(theta0(1,t)) '.png'])
        ...
        ylabel ('Duty Cycle of Grating','FontSize',16)
        zlabel ('Reflection Efficiency','FontSize',16)
        title ({['Reflected Diffraction Efficiency for 1D ' gratingcaselabel(gratingcase+1,:) ' Grating Duty Cycle Sweep for TM Light with '],[ num2str(thickness_total(1,thick)) ' um thickness, ' num2str(Lambda(1,L)) ' um period for ' num2str(lambda(1,l)) ' um light from n=' num2str(n1) ' to n=' num2str(n3) ', AOI=' num2str(theta0(1,t))]},'FontSize',14)
        saveas(h8,['.\figures\Reflected Diffraction Efficiency for 1D ' gratingcaselabel(gratingcase+1,:) ' Grating Duty Cycle Sweep for TM Light with ' num2str(thickness_total(1,thick)) ' um thickness, ' num2str(Lambda(1,L)) ' um period for ' num2str(lambda(1,l)) ' um light from n=' num2str(n1) ' to n=' num2str(n3)  ', AOI=' num2str(theta0(1,t)) '.png'])
    ...
    case 5
        ...
        zlabel ('Transmision Efficiency','FontSize',16)
        title ({['Transmitted Diffraction Efficiency for 1D ' gratingcaselabel(gratingcase+1,:) ' Grating AOI Sweep for TM Light with '],[ num2str(thickness_total(1,thick)) ' um thickness ' num2str(dutycycle(1,d)) ' duty cycle for ' num2str(lambda(1,l)) ' um light from n=' num2str(n1) ' to n=' num2str(n3)]},'FontSize',14)
        saveas(h9,['.\figures\Transmitted Diffraction Efficiency for 1D ' gratingcaselabel(gratingcase+1,:) ' Grating AOI Sweep for TM Light with ' num2str(thickness_total(1,thick)) ' um thickness ' num2str(dutycycle(1,d)) ' duty cycle for ' num2str(lambda(1,l)) ' um light from n=' num2str(n1) ' to n=' num2str(n3) '.png'])
        ...
        ylabel ('Angle of Incidence (deg)','FontSize',16)
        zlabel ('Reflection Efficiency','FontSize',16)
        title ({['Reflected Diffraction Efficiency for 1D ' gratingcaselabel(gratingcase+1,:) ' Grating AOI Sweep for TM Light with '],[ num2str(thickness_total(1,thick)) ' um thickness ' num2str(dutycycle(1,d)) ' duty cycle, ' num2str(Lambda(1,L)) ' um period for ' num2str(lambda(1,l)) ' um light from n=' num2str(n1) ' to n=' num2str(n3)]},'FontSize',14)
        saveas(h10,['.\figures\\figures\Reflected Diffraction Efficiency for 1D ' gratingcaselabel(gratingcase+1,:) ' Grating AOI Sweep for TM Light with ' num2str(thickness_total(1,thick)) ' um thickness ' num2str(dutycycle(1,d)) ' duty cycle, ' num2str(Lambda(1,L)) ' um period for ' num2str(lambda(1,l)) ' um light from n=' num2str(n1) ' to n=' num2str(n3) '.png'])
