...
% 10 = 'Arbitrary'
% 11 = '2x^2 symmetric'
gratingcaselabel = ['Binary';'Blaze1';'Blaze2';'Sin   ';'Triang';'Parabo';'GenTri';'Trapez';'Tetrag';'Gaussi';'Arbitr';'2x^2  '];
...
lambda_delta = 0.1; %sets delta for wavelength steps for sweep in micrometers
...
Lambda_min = 0.75; %sets minimum grating period for sweep in micrometers
Lambda_max = 1;   %sets maximum grating period for sweep in micrometers
Lambda_delta = 0.25; %sets delta for grating period steps for sweep in micrometers

thickness_total_min = 0.8; %sets minimum grating thickness for sweep in micrometers
...
n3 = 400;   %sets index of refraction for substrate and grating teeth material
