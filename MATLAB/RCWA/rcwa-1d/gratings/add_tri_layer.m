...
function data_layer=add_tri_layer(Lambda,Lambda_object,layer_thickness_,ref_index_in,ref_index_out,n_layers)
...
pomocna=-Lambda_object/(2*d)*(new_z-d); %inverzní fuknkce
...
switch plot_grating
    case 1
        figure;
        x1=-Lambda_object/2:Lambda_object/100:0;
        x2=0:Lambda_object/100:Lambda_object/2;
        
        y1=d-2*d/Lambda_object*x2;
        y2=d+2*d/Lambda_object*x1;
        hold on
        plot(x2,y1,'r','LineWidth',2);
        plot(x1,y2,'r','LineWidth',2);
        line([-Lambda_object/2,Lambda_object/2],[0,0],'Color','r','LineWidth',2);
