...
function [diff_R, diff_R_angles, diff_T, diff_T_angles] = main_binary(lambda,theta0,polarization,Lambda,thickness_total,dutycycle,n1,n3,gratingcase)
...
% lambda=lambda; % wavelength (um)
use_dispersion=1; % 1-yes, 2-no, see file setup_dispersion.m setup_dispersion.m
% theta0=0; % incident angle [degree]
polarization= polarization; % 0-conical diffraction, 1-TM polarization, 2-TE polarization
...
grating=gratingcase; % switch grating
...
switch grating
    ...
    case 6 % general triangular grating
        number_of_layers=120;
        a=0.5; % distance of the triangular top, from left corner 0<a<1
        b=1; % size of the triangular base 0<b<1
    ...
    case 8 % tetragonal grating
        number_of_layers=20;
        a_1=0.3; % horizontal position of the left top edge (all numbers are proportions, not absolute distances)
        a_2=0.1; % horizontal position of the right top edge
        c_1=1; % vertical position of the left top edge
        c_2=1; % vertical position of the right top edge
        b=1; % size of the tetragonal base (as a portion of Lambda, like duty cycle)
    case 9 % Gaussian grating
        number_of_layers=20;
    case 10 % arbitrary grating from file
        grating_relative_dimensions=2; % 1-relative size, 2-absolute size
    case 11 % 2x^2 grating
        number_of_layers=20;
