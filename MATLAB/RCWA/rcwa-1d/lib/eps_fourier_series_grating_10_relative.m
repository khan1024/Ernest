...
for i=3:2:size_data_x
    if isnan(data(l,index(i)))==1
        ...
        epsG=epsG+data(l,index(i))^2*(data(l,index(i+1))-data(l,index(i-1)));
    end
end
...
for i=3:2:size_data_x
    if isnan(data(l,index(i)))==1
        ...
        i_epsG=i_epsG+(1/data(l,index(i))^2)*(data(l,index(i+1))-data(l,index(i-1)));
    end
end
%------------------------------------------------------------------------
...
for i=3:2:size_data_x
    if isnan(data(l,index(i)))==1
        ...
        v_p=v_p+data(l,index(i))^2*(-exp(-1i*2*pi*(1:M)*data(l,index(i+1)))./(1i*2*pi*(1:M))+ ...
            exp(-1i*2*pi*(1:M)*data(l,index(i-1)))./(1i*2*pi*(1:M)));
    end
end
...
for i=3:2:size_data_x
    if isnan(data(l,index(i)))==1
        ...
        v_m=v_m+data(l,index(i))^2*(-exp(-1i*2*pi*(-M:-1)*data(l,index(i+1)))./(1i*2*pi*(-M:-1))+ ...
        exp(-1i*2*pi*(-M:-1)*data(l,index(i-1)))./(1i*2*pi*(-M:-1)));
    end
end
...
for i=3:2:size_data_x
    if isnan(data(l,index(i)))==1
        ...
        i_vp=i_vp+(1/data(l,index(i))^2)*(-exp(-1i*2*pi*(1:M)*data(l,index(i+1)))./(1i*2*pi*(1:M))+ ...
        exp(-1i*2*pi*(1:M)*data(l,index(i-1)))./(1i*2*pi*(1:M)));
    end
end
...
for i=3:2:size_data_x
    if isnan(data(l,index(i)))==1
        ...
        i_vm=i_vm+(1/data(l,index(i))^2)*(-exp(-1i*2*pi*(-M:-1)*data(l,index(i+1)))./(1i*2*pi*(-M:-1))+ ...
        exp(-1i*2*pi*(-M:-1)*data(l,index(i-1)))./(1i*2*pi*(-M:-1)));
    end
end
